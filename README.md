...
- Generación de estadísticas morfométricas de volumen, área, índice de plegamiento y grosor cortical.
...
- Visualización de mallas corticales (superficies white y pial) en imágenes 2D.
